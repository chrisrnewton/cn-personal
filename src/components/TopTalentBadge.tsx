...
#toptal-badge { --h: polygon(50% 0,100% 24%,100% 76%,50% 100%,0 76%,0 24%); font-family: proxima-nova, Arial, sans-serif; }
#toptal-badge .h { display: inline-block; background: #25a9ef; padding: 6px; clip-path: var(--h); }
#toptal-badge .a { width: 200px; padding: 24px 0 40px; display: flex; flex-direction: column; align-items: center; gap: 8px; color: #fff; text-align: center; background: linear-gradient(153deg, #0667ff 18%, #204ecf 40%, #0f256e 80%); clip-path: var(--h); box-shadow: 0 28px 50px rgba(6,30,96,.35); }
...
#toptal-badge .d { font-size: 16px; opacity: .8; margin-bottom: -6px; }
